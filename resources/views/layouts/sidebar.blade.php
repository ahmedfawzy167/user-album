...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            ...
            <div id="usersCollapse" class="collapse" aria-labelledby="headingUsers" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{route('users.index')}}"><i class="fa-solid fa-list"></i>  All Users</a>
                    <a class="collapse-item" href="{{route('users.create')}}"><i class="ion-plus-circled"></i> Add New User</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#albumsCollapse"
                aria-expanded="true" aria-controls="albumsCollapse">
                <i class="ion-ios-albums"></i>
                <span>Albums</span>
            </a>
            <div id="albumsCollapse" class="collapse" aria-labelledby="headingAlbums" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{route('albums.index')}}"><i class="fa-solid fa-list"></i>  All Albums</a>
                    <a class="collapse-item" href="{{route('albums.create')}}"><i class="ion-plus-circled"></i> Add New Album</a>
                </div>
            </div>
        </li>
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="get" action="{{route('search')}}">
                    ...
                    <div class="input-group">
                        <input type="text" name="term" class="form-control bg-light border-0 small" placeholder="Search for User by Name ..."
                            aria-label="Search" value="{{request('term') != "" ? request('term') : ''}}" aria-describedby="basic-addon2">
